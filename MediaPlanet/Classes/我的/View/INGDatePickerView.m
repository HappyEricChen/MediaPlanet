...
@interface INGDatePickerView()
@property (nonatomic, strong) NSString *selectDate;

@end

@implementation INGDatePickerView

+ (INGDatePickerView *)instanceDatePickerView
{
    NSArray* nibView =  [[NSBundle mainBundle] loadNibNamed:@"INGDatePickerView" owner:nil options:nil];
...
- (IBAction)sureClick:(id)sender {
    ...
    [self.delegate getSelectDate:self.selectDate type:self.Datetype];
